#include "HeaderFiles/VarFitterClosureTest.h"

using namespace std;
using namespace RooFit;

int VarFitterClosureTest(vector<VarToBeFitted> *tobefitted,
                         bool debug)
{
    // Fixing RJPsi
    Double_t RJPsi = 0.2;
    ...
    */
        ...
        */
        ...
        TLegend leg_fitwithratio = it_tobefit->SetLegendPosAuto();
        leg_fitwithratio.SetX1(it_tobefit->legend_position_x0);
        leg_fitwithratio.SetX2(it_tobefit->legend_position_x1);
        leg_fitwithratio.SetY1(it_tobefit->legend_position_y0);
        leg_fitwithratio.SetY2(it_tobefit->legend_position_y1);
        ...
        inclusive_canvas->Print(TString::Format("ClosureTest_FitRatio_Plot_%s.png", varfit_name).Data());
        inclusive_canvas->Clear();
    }
    return 0;
}